                    ...
                    <div class="relative">
                        ...
                        <div id="alerts-bell-dropdown" class="absolute right-0 z-30 mt-2 hidden w-80 rounded-2xl border border-slate-200 bg-white p-3 shadow-soft dark:border-slate-700 dark:bg-slate-900">
                            <div class="mb-3 flex items-center justify-between">
                                ...
                                <a href="alerts" class="text-xs font-semibold text-brand-500 hover:text-brand-600">View all</a>
                            </div>
                    ...
                    <div class="flex flex-col gap-8 p-6 sm:p-8 lg:flex-row lg:items-center lg:justify-between">
                        <div class="space-y-4">
                            ...
                            <div class="flex flex-wrap gap-3">
                                <a href="/#run-audit" class="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-brand-500 to-brand-400 px-5 py-3 text-sm font-semibold text-white shadow-soft transition hover:opacity-90">Run New Audit</a>
                                <a href="history" class="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800">View History</a>
                            </div>
                        </div>
            ...
            <section class="grid gap-6 xl:grid-cols-3">
                <article class="surface-card p-6 shadow-soft sm:p-8">
                    <div class="flex items-center justify-between gap-4">
                        ...
                        <a href="history" class="inline-flex items-center rounded-xl border border-slate-200 bg-white px-4 py-2 text-xs font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800">Open History</a>
                    </div>
                    <div class="mt-6 h-64">
                        ...
                        <?php foreach ($recentAudits as $audit): ?>
                            ...
                            <article class="audit-card rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-900">
                                ...
                                <div class="mt-3 flex items-center justify-between">
                                    ...
                                    <a href="results?id=<?php echo (int) $audit['id']; ?>" class="text-xs font-semibold text-brand-500 transition hover:text-brand-600">View Report -></a>
                                </div>
                            </article>
                        <?php endforeach; ?>
                    <?php else: ?>
